...
public class Award
{
  ...
  static
  {
    ...
    awards.add( new Award( 0,"You Got it, Dude","Most correct overall", 1 ) );
    awards.add( new Award( 1,"Total Screwups","Most incorrect overall", 1 ) );
    awards.add( new Award( 2,"Sultans of Swipe","Most skips overall", 1 ) );
    awards.add( new Award( 3,"Fast and Furious","Highest scoring round", 1 ) );
    awards.add( new Award( 4,"2 Fast, 2 Furious","Most correct in round without winning", 2 ) );
    awards.add( new Award( 5,"Slackers","Most skips in a round", 1 ) );
    awards.add( new Award( 6,"Foot in Mouth","Most incorrect in a round", 1 ) );
    awards.add( new Award( 7,"Paralyzed by Fear","Only skipped cards for an entire round", 2 ) );
    awards.add( new Award( 8,"Dead Weight","Negative scoring round", 2 ) );
    awards.add( new Award( 9,"Pointless","Zero point round", 2 ) );
    awards.add( new Award( 10,"Out to Lunch","Take no action in a round", 2 ) );
    awards.add( new Award( 11,"Quickdraw","Very fast correct", 3 ) );
    awards.add( new Award( 12,"Glass Half Empty", "Very fast skip", 3 ) );
    awards.add( new Award( 13,"Over Before it Started","Buzzed very quickly", 3 ) );
    awards.add( new Award( 14,"Took You Long Enough!","Very slow correct", 3 ) );
    awards.add( new Award( 15,"...Did I do that?","Buzzed after a long time", 3 ) );
    awards.add( new Award( 16,"Worst Guessers","Skipped after a long time", 3 ) );
